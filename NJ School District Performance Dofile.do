...
**** // Data Formats and Conversion Problem Set #1// (STARTS LINE 11 TO 27 THEN LINE 72 TO 152)
****// Manipulating Data Problem Set #2 // (LINE 27 TO 72 THEN LINE 152 TO ___)
...
use "https://github.com/RickConnelly/Data-Management/blob/master/MathParticipationPerform_2019.dta?raw=true", clear //This is the raw data pulled directly from the NJ DOE //

drop Subject //Drops unneeded variable //
...
ren ProfRateFederalAccountability MATHProfRateFederalAccount
...
// The purpose of this research is about Abbot Public Schools, to that end I'm dropping observations on Charter Schools and overall State statistics // 

save NJ_MATH_2018_19, replace //Saves the data be later pulled to merge with English Language Arts Scores //

use "https://github.com/RickConnelly/Data-Management/blob/master/ELALiteracyParticipationPerform_2019.dta?raw=true", clear
...
ren ProfRateFederalAccountability ELAProfRateFederalAccount
...
save NJ_ELA_2018_19, replace // Saves the data be later pulled to merge with Math Scores //
...
merge 1:1 CountyCode CountyName DistrictCode DistrictName StudentGroup using NJ_MATH_2018_19 // Merges Math Performance with ELA Performance Data for the 2018-2019 school year //
...
replace ELAProfRateFederalAccount="." if ELAProfRateFederalAccount=="*"
replace ELAProfRateFederalAccount="." if ELAProfRateFederalAccount=="N"  
...
replace MATHProfRateFederalAccount="." if MATHProfRateFederalAccount=="*"
replace MATHProfRateFederalAccount="." if MATHProfRateFederalAccount=="N"  
...
recode DistrictName2 (9=1) (49=1) (55=1) (62=1) (76=1) (115=1) (126=1) (159=1) (166=1) (193=1) (208=1) (219=1) (224=1) (225=1) (261=1) (303=1) (330=1) (333=1) (374=0) (378=1) (380=1) (385=1) (386=1) (392=1) (393=1) (436=1) (487=1) (490=1) (501=1) (526=1) (nonm = 0), gen(Abbot_SchoolDist)
...
// For this test I'd like to look at each demographic in each of the Abbot schools, probably by keep if Abbot_SchoolD == 1 and then collapse ELADistrictPerformance MATHDistrictPerformance, by (DistrictName2) //
